 ...
 */
final class Version20210328073754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sos (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, message VARCHAR(50) NOT NULL, is_anonymous TINYINT(1) NOT NULL, is_closed TINYINT(1) NOT NULL, INDEX IDX_829F58F5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, job_id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, birth_date DATE NOT NULL, hiring_date DATE NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(10) NOT NULL, is_executive TINYINT(1) NOT NULL, is_psychologist TINYINT(1) NOT NULL, is_admin TINYINT(1) NOT NULL, INDEX IDX_8D93D649BE04EA9 (job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
