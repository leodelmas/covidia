 ...
 */
final class Version20210121163652 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE working_day (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, date DATE NOT NULL, is_teleworked TINYINT(1) NOT NULL, INDEX IDX_41EBDDE8A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649BE04EA9 FOREIGN KEY (job_id) REFERENCES job (id)');
        $this->addSql('ALTER TABLE working_day ADD CONSTRAINT FK_41EBDDE8A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE working_day DROP FOREIGN KEY FK_41EBDDE8A76ED395');
